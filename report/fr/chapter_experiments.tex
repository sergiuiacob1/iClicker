...
% I became interested in how the facial landmarks are detected by the libraries I used, in order to extract the face or the eyes from images.
% I began studying on network architectures such as Encoder–Decoder and reading about Cascaded Convolutional Networks, but this is still a work in progress.
% This section will be completed in the final version of the project.